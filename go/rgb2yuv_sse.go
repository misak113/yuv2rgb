...
func init() {
	// TODO Implement accelerated BGRA SSE
	// bgra2yuvFns[priorityMedium] = append(bgra2yuvFns[priorityMedium], ConvertBGRAToYCbCrImageSSEUnaligned)
	rgba2yuvFns[priorityMedium] = append(rgba2yuvFns[priorityMedium], ConvertRGBAToYCbCrImageSSEUnaligned)
}
